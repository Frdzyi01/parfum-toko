                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item active open">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                                <a
                                    href="{{ asset('template-admin/html/vertical-menu-template/dashboards-crm.html') }}"
                                    target="_blank"
                                    class="menu-link">
                            ...
                            <li class="menu-item">
                                <a
                                    href="{{ asset('template-admin/html/vertical-menu-template/app-ecommerce-dashboard.html') }}"
                                    target="_blank"
                                    class="menu-link">
                            ...
                            <li class="menu-item">
                                <a
                                    href="{{ asset('template-admin/html/vertical-menu-template/app-logistics-dashboard.html') }}"
                                    target="_blank"
                                    class="menu-link">
                            ...
                            <li class="menu-item">
                                <a
                                    href="{{ asset('template-admin/html/vertical-menu-template/app-academy-dashboard.html') }}"
                                    target="_blank"
                                    class="menu-link">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a
                                    href="{{ asset('template-admin/html/front-pages/landing-page.html') }}"
                                    class="menu-link"
                                    target="_blank">
                            ...
                            <li class="menu-item">
                                <a
                                    href="{{ asset('template-admin/html/front-pages/pricing-page.html') }}"
                                    class="menu-link"
                                    target="_blank">
                            ...
                            <li class="menu-item">
                                <a
                                    href="{{ asset('template-admin/html/front-pages/payment-page.html') }}"
                                    class="menu-link"
                                    target="_blank">
                            ...
                            <li class="menu-item">
                                <a
                                    href="{{ asset('template-admin/html/front-pages/checkout-page.html') }}"
                                    class="menu-link"
                                    target="_blank">
                            ...
                            <li class="menu-item">
                                <a
                                    href="{{ asset('template-admin/html/front-pages/help-center-landing.html') }}"
                                    class="menu-link"
                                    target="_blank">
                    ...
                    <li class="menu-item">
                        <a
                            href="{{ asset('template-admin/html/vertical-menu-template/app-email.html') }}"
                            target="_blank"
                            class="menu-link">
                    ...
                    <li class="menu-item">
                        <a
                            href="{{ asset('template-admin/html/vertical-menu-template/app-chat.html') }}"
                            target="_blank"
                            class="menu-link">
                    ...
                    <li class="menu-item">
                        <a
                            href="{{ asset('template-admin/html/vertical-menu-template/app-calendar.html') }}"
                            target="_blank"
                            class="menu-link">
                    ...
                    <li class="menu-item">
                        <a
                            href="{{ asset('template-admin/html/vertical-menu-template/app-kanban.html') }}"
                            target="_blank"
                            class="menu-link">
                    ...
                    <li class="menu-item">
                        <a
                            href="{{ asset('template-admin/html/vertical-menu-template/form-validation.html') }}"
                            target="_blank"
                            class="menu-link">
                    ...
                    <li class="menu-item">
                        <a
                            href="{{ asset('template-admin/html/vertical-menu-template/tables-datatables-basic.html') }}"
                            target="_blank"
                            class="menu-link">
                            <i class="menu-icon tf-icons bx bx-grid"></i>
                    ...
                    <li class="menu-item">
                        <a
                            href="{{ asset('template-admin/documentation/') }}"
                            target="_blank"
                            class="menu-link">
                                    ...
                                    <div class="d-flex align-items-start row">
                                        ...
                                        <div class="col-sm-5 text-center text-sm-left">
                                            <div class="card-body pb-0 px-0 px-md-6">
                                                <img
                                                    src="{{ asset('template-admin/assets/img/illustrations/man-with-laptop.png') }}"
                                                    height="175"
                                                    alt="View Badge User" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-6 mb-6 payments">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                                    <div class="avatar flex-shrink-0">
                                                        <img src="{{ asset('template-admin/assets/img/icons/unicons/paypal.png') }}" alt="paypal" class="rounded" />
                                                    </div>
                                                    <div class="dropdown">
                                                        <button
                                                            class="btn p-0"
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body pt-4">
                                        <ul class="p-0 m-0">
                                            ...
                                            <li class="d-flex align-items-center mb-6">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="{{ asset('template-admin/assets/img/icons/unicons/cc-primary.png') }}" alt="User" class="rounded" />
                                                </div>
                                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                    <div class="me-2">
