...
<section class="checkout spad">
    <div class="container">
        <form action="{{ route('pemesanan.proses') }}" method="POST" class="checkout__form">
            @csrf
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="checkout__form__input">
                                ...
                                <input type="text" name="catatan" placeholder="Catatan khusus untuk pesanan Anda..."
                                       value="{{ old('catatan') }}">
                                @error('catatan')
                    ...
                    <div class="checkout__order">
                        ...
                        <div class="checkout__order__product">
                            <ul>
                                ...
                                @foreach($keranjang->item as $index => $item)
                                <li>
                                    {{ $index + 1 }}. {{ $item->produk->nama }}
                                    (x{{ $item->jumlah }})
                        ...
                        <div class="checkout__order__total">
                            <ul>
                                <li>Subtotal <span>Rp {{ number_format($keranjang->ambilTotal(), 0, ',', '.') }}</span></li>
                                <li>Total <span>Rp {{ number_format($keranjang->ambilTotal(), 0, ',', '.') }}</span></li>
                            </ul>
                        </div>
